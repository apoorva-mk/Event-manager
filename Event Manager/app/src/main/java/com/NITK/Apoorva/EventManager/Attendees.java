...
public class Attendees extends AppCompatActivity {
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position) {
                case 0:
                    //MainActivity.currentActivity="Tab1";
                    AttendeesList tab1 = new AttendeesList();
                    tab1.setCurrTab("Tab1");
                    return tab1;

                case 1:
                    //MainActivity.currentActivity="Tab2";
                    AttendeesList tab2 = new AttendeesList();
                    tab2.setCurrTab("Tab2");
                    return tab2;
