...
public class ApproveAttendance extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.approve_attendance, container, false);

    super.onCreate(savedInstanceState);
    MainActivity.currentActivity="ApproveAttendance";
