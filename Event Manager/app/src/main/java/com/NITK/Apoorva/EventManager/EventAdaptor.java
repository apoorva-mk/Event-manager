...
import static com.NITK.Apoorva.EventManager.R.layout.event_list_row;
    ...
    public static class LoginDialog extends AppCompatDialogFragment {
            ...
            else
            {
                builder.setTitle("Do you wish to send reminder for event!")
                        ...
                        .setNegativeButton("Confirm", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialogInterface, int i) {
                                MainActivity.databaseReference.child("Reminder").child(e.geteID()).setValue("1");
        ...
        public void onBindViewHolder(final MyViewHolder holder, final int position) {
            ...
            switch(e.getSig())
            {
                ...
                case "Media": holder.title.setBackgroundTintList(context.getResources().getColorStateList(R.color.rose));

                    break;

                case "Vidyut": holder.title.setBackgroundTintList(context.getResources().getColorStateList(R.color.green));
                    break;

                case "Kaaryavarta": holder.title.setBackgroundTintList(context.getResources().getColorStateList(R.color.grey));
                    break;

                case "Yantrika": holder.title.setBackgroundTintList(context.getResources().getColorStateList(R.color.pink));
                    break;

                case "Saahitya": holder.title.setBackgroundTintList(context.getResources().getColorStateList(R.color.purple));
                    break;

                 default: holder.title.setBackgroundTintList(context.getResources().getColorStateList(R.color.khaki));
